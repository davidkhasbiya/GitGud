            ...
            <Container>
                ...
                <div className="py-20 text-center">
                    ...
                    <p className="mx-auto mt-6 max-w-xl leading-7 text-zinc-400">
                        AI-powered developer learning platform for mastering
                        programming through practical challenges, intelligent
                        feedback, personalized recommendations, and continuous
                        progress tracking.
                    </p>
